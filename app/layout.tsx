...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "HdL-Verleih vermietet den Klassiker „Hau den Lukas“ und professionelle Musikanlagen in Frankenberg (Eder) und Umgebung.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hau den Lukas & Musikanlage | HdL-Verleih",
      },
    ],
    locale: "de_DE",
    type: "website",
